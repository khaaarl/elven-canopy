...
pub(super) fn spawn_second_elf(sim: &mut SimState) -> CreatureId {
...
pub(super) fn sim_with_elf_for_thoughts() -> (SimState, CreatureId) {
...
pub(super) fn insert_pursuit_task(
    sim: &mut SimState,
    pursuer: CreatureId,
    target: CreatureId,
...
pub(super) fn create_debug_dance(
    sim: &mut SimState,
    location: VoxelCoord,
