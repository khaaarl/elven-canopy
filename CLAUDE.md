...
- **Phase 4 (Economy and Ecology):** Kitchen cooking, elf personal item acquisition, creature thoughts, and basic mood scoring implemented. Toast-style notification display (UI only, not yet wired to sim events); rest not started.
